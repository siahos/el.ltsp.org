...
Η εκκίνηση της *Παρακολούθηση συστήματος* γίνεται από το μενού  ή
...
διεργασία που εμφανίζει πρόβλημα και κάνουμε . Στην ειδοποίηση
που εμφανίζεται, κάνουμε "κλικ" στο πλήκτρο **"Τερματισμός
