[right](Αρχείο:Ts_promo_ubuntu-VM.jpg "wikilink") Για να δοκιμάσετε το
...
Για να χρησιμοποιήσετε την ιδεατή μηχανή θα πρέπει:
  ...
  - [να εγκαταστήσετε την εφαρμογή
    VirtualBox](Windows/Προχωρημένα/VirtualBox#Εγκατάσταση "wikilink")
    στον MS-Windows σταθμό εργασίας (host),
  - [να εισάγετε την ιδεατή
    μηχανή](Εφαρμογές/VirtualBox#Εισαγωγή_προϋπάρχουσας_ιδεατής_μηχανής "wikilink"),
  - [να εκκινήσετε την ιδεατή
    μηχανή](Εφαρμογές/VirtualBox#Οδηγός_Χρήσης "wikilink"),
  - να συνδεθείτε ως [διαχειριστής](#Διαχειριστής_συστήματος "wikilink")
    στον εξυπηρετητή Ubuntu LTSP (ιδεατή μηχανή),
  - να [εκκινήστε την εφαρμογή
    sch-scripts](Linux/sch-scripts/Εκκίνηση_της_εφαρμογής "wikilink"):
      - να δώσετε μία [στατική IP στον εξυπηρετητή της ιδεατής
        μηχανής](Linux/sch-scripts/Στατική_IP "wikilink") (η
      ...
      - να [δημιουργήσετε τον εικονικό δίσκο για τα LTSP
        clients](Linux/sch-scripts/Δημοσίευση_εικονικού_δίσκου "wikilink")
