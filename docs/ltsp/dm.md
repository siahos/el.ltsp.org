...
!!! tip "Χρήσιμο"
    Η χειρωνακτική σύνδεση **και για τον LTSP server**, μετά από δημοσίευση
    εικονικού δίσκου, **θα εφαρμοστεί και σε όλα τα clients**. Σε αυτήν την
    περίπτωση δεν είναι απαραίτητη η αντίστοιχη παράμετρος στο `ltsp.conf`. Το
    αρχείο μπορείτε να το δημιουργήσετε/επεξεργαστείτε με `sudo pluma
