...
Ο ++"ΕΠΕΞΕΡΓΑΣΤΗΣ ΚΑΤΑΤΜΉΣΕΩΝ GPARTED"++ είναι μία εφαρμογή που προσφέρει γραφικό περιβάλλον για τη διαχείριση των διαμερίσεων των δίσκων και είναι προεγκατεστημένος στο Ubuntu MATE.
...
το ++"Software Boutique"++ ή το ++"Synaptic"++, κάνοντας αναζήτηση την λέξη
