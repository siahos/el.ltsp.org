...
## Για περιγραφή πλήκτρων
    ...
    **`όνομα πλήκτρου`** ή και συνδιασμός με τη χρήση + (όπου ` βάζουμε backticks)
...
1.  Όταν συνδιάζεται με πλήκτρο:
        ...
        **`Ctrl`**+**`κλικ`** (όπου ` βάζουμε backticks)
...
Παράδειγμα σύνταξης:
    ...
    ```shell-session (όπου ` βάζουμε backticks)
...
Παράδειγμα σύνταξης:
    ...
    ```text title="όνομα αρχείου" (όπου ` βάζουμε backticks)
