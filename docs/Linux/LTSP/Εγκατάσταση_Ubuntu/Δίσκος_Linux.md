[350px](Αρχείο:12.04.3_ubuntu_install_keep_linux_install_type.png "wikilink")
...
[350px](Αρχείο:12.04.3_ubuntu_install_keep_linux_choose_size.png "wikilink")
Εάν θέλετε να εγκαταστήσετε το Ubuntu παράλληλα με το περιβάλλον Linux
που έχετε:

1.  Επιλέξτε την πρώτη επιλογή

    [650px](Αρχείο:12.04.3_ubutnu_install_keep_linux_choice.png "wikilink")
...
1.  Επιλέξτε την δεύτερη επιλογή
    ...
    [650px](Αρχείο:12.04.3_ubuntu_install_upgrade_linux_choice.png "wikilink")
...
[350px](Αρχείο:12.04.3_ubuntu_install_replace_linux_choose_size.png "wikilink")
...
1.  Επιλέξτε την τρίτη επιλογή
    ...
    [650px](Αρχείο:12.04.3_ubuntu_install_replace_linux_choice.png "wikilink")
    και έπειτα .
