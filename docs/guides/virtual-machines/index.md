...
## Κλωνοποίηση μέσω LTSP server {:#vmdk-ltsp}
...
### Βήματα υλοποίησης {:#vmdk-ltsp-steps}
...
## Κλωνοποίηση μέσω Live USB {:#vmdk-liveusb}
...
3.  Ίδιες ενέργειες με το **βήμα 4** του [προηγούμενου
    οδηγού](#vmdk-ltsp-steps).
