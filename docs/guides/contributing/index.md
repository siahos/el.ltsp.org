...
!!! info "Πληροφορία"
    Από προεπιλογή ανάμεσα στις αριθμήσεις/κουκκίδες εφαρμόζεται **wraping**.
    Αν όμως θέλετε να ΑΠΕΝΕΡΓΟΠΟΙΗΣΕΤΕ το wraping π.χ. κάποια αρίθμηση/κουκκίδα
    περιέχει εικονα, θα πρέπει στο τέλος της συγκεκριμένης αρίθμησης/κουκκίδας
    να προσθέστε το λεκτικό`{.clear}`.
...
!!! info "Πληροφορία"
    ...
    3.  Από προεπιλογή εφαρμόζεται **wraping** π.χ. όταν προηγείται εικόνα.

        Αν όμως θέλετε να ΑΠΕΝΕΡΓΟΠΟΙΗΣΕΤΕ το wraping, ώστε τα admonitions **να
        καλύπτουν όλο το πλάτος της σελίδας**, τότε πρέπει να προστεθεί το λεκτικό
        `clear`, π.χ.
