...
Παράδειγμα σύνταξης:
    ...
    Μπορείτε να προσθέσετε πράσινο ![✔][✔] και κόκκινο ![✖][✖] σύμβολο ως εικόνα μέσα σε κείμενο ή πίνακα.
...
!!! warning "Προσοχή"
    **Μην** αντιγράφετε το πράσινο ή το κόκκινο σύμβολο γιατί είναι εικόνες!

Στο τέλος του αρχείου, θα πρέπει να προσθέσετε τα σχετικά paths των αντίστοιχων
εικόνων, όπως τα ακόλουθα παραδείγματα:
