...
!!! tip "Συμβουλή"
    Για εύκολη αντιγραφή των συμβόλων χρησιμοπιήστε αυτά της επικεφαλίδας ***Για προσθήκη των συμβόλων ✔ και ✖ μέσα σε κείμενο***. ΜΗΝ αντιγράφετε το κόκκινο ή πράσινο σύμβολο γιατί είναι εικόνες!
