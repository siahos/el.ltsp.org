...
!!! info "Πληροφορία"
    Από προεπιλογή ανάμεσα στις αριθμήσεις/κουκκίδες εφαρμόζεται **wrapping**.
    Αν όμως θέλετε να **απενεργοποιήσετε** το wrapping π.χ. κάποια
    αρίθμηση/κουκκίδα περιέχει εικονα, θα πρέπει στο τέλος της συγκεκριμένης
    αρίθμησης/κουκκίδας να προσθέσετε το λεκτικό`{.clear}`.
...
!!! info "Πληροφορία"
    ...
    3.  Από προεπιλογή εφαρμόζεται **wrapping** π.χ. όταν προηγείται εικόνα. Αν όμως
        θέλετε να **απενεργοποιήσετε** το wrapping, ώστε τα admonitions **να καλύπτουν
        όλο το πλάτος της σελίδας**, τότε πρέπει να προσθέσετε το λεκτικό `clear`, π.χ.
